...
export default function UserPage() {
  ...
  const [studentNum, setStudentNum] = useState(false);
    ...
    <>
      <Container>
        <Stack direction="row" alignItems="center" justifyContent="space-between" mb={5}>
          ...
          <Button variant="contained" startIcon={<Iconify icon="eva:plus-fill" />} onClick={handleOpen2}>
            New Tutor
          </Button>
          <Modal
              ...
              <Box sx={style}>
                ...
                <Typography id="transition-modal-description" sx={{ mt: 2 }}>
                  ...
                  <TextField
                    ...
                    style={{ width: '100%' }}
                    onChange={(newValue) => {
                      setLastName1(newValue);
                    }}
                  />
                  <br />
                  <TextField
                    id="standard-basic"
                    label="Studnent Number"
                    variant="standard"
                    style={{ width: '100%' }}
                    onChange={(newValue) => {
                  ...
                  >
                    ...
                    <MenuItem value={'DBP'}>DBP</MenuItem>
                  </Select>
                  <br />
                  <br />
                  <br />
                  <Button style={{ width: '100%' }} variant="contained" onClick={createAcc}>
                    Create Account
                  </Button>
                </Typography>
              </Box>
